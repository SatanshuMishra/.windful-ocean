...
export const CI_ENFORCER_CHECK_TOKENS = Object.freeze(['receipts', 'd6', 'cluster-boundary', 'pr-title-lint', 'invariant-coverage', 'determinism', 'exec-allowlist', 'dispatchable-agent-schema-capable']);
