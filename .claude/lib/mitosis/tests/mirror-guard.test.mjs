...
const INLINED_TWINS = Object.freeze({
  ...
  'retry.mjs': WHOLE,
  'run-engine.mjs': Object.freeze([
    'COUPLING_DECISION_VOCABULARY', 'couplingSerializeViolations', 'ingestTaskFileScopes', 'engineWorktreePath',
    'planIncomplete', 'BLAST_RADIUS_K', 'LAYER3_SONNET_ENABLED', 'sensitiveScope', 'irreversible', 'breakingContract',
    'blastRadius', 'securityReviewRequired', 'policyModelFor', 'planReviewModelFor', 'concreteFindings',
    'resolvePlanReview', 'planGroundTruthSeed', 'authorTaskModels', 'routingTelemetry', 'guardModelDecision',
    'makeModelGuard', 'runEngine',
  ]),
  'coarse-scope-lint.mjs': Object.freeze([
    'normalizePath', 'GLOB_MAX_LENGTH', 'GLOB_MAX_WILDCARDS', 'globMatches', 'scopeCovers',
    'COARSE_SCOPE_FILE_THRESHOLD', 'scopeDirPrefix', 'scopeIsSpecificFile', 'scopeIsBareTopLevelDir',
    'namedFilesInText', 'isFileScopePack', 'fileScopeEdit', 'lintCoarseScope',
  ]),
  'run-log.mjs': WHOLE,
  'saga.mjs': WHOLE,
