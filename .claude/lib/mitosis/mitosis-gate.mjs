...
export const MITOSIS_GATE_VERBS = Object.freeze(['boundary-parity', 'determinism', 'dispatchable-agent-schema-capable', 'exec-allowlist', 'journal-parity', 'phase-parity', 'prompt-registry', 'transcription-parity']);
...
const TARGETLESS_VERBS = Object.freeze(new Set(['boundary-parity', 'exec-allowlist', 'journal-parity', 'prompt-registry', 'transcription-parity']));
