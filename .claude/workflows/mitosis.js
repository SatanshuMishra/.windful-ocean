...
function makePublishIntent({ unitId, head, sha, base, title, body, mergePolicy } = {}) {
...
function appendIntent(outbox, intent) {
...
function classifyDrainResult(readback) {
