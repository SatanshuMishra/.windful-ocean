...
- Verification is governed by ONE external closed standard, receipts/gates@1.1: never invent or promote a project-local verification mandate, acceptance is a ceiling declared before work starts, and an unclearable gate becomes a tracked ladder downgrade rather than another review round. ~/.claude/rules/common/receipts.md
